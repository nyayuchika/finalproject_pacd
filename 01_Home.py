...
# --- CSS INJECTION (PENTING) ---
# Taruh ini SEBELUM definisi kolom
st.markdown("""
<style>
...
with col1:
    ...
    # Teks dengan margin-top negatif agar naik ke atas
    st.markdown(f"<h5 style='font-family:sans-serif; text-align:center; margin-bottom:0; margin-top:{text_margin_top};'>Nyayu Chika Marselina</h5>", unsafe_allow_html=True)
    ...
    # Button (otomatis rata tengah karena CSS di atas)
...
with col2:
    ...
    st.markdown(f"<h5 style='font-family:sans-serif; text-align:center; margin-bottom:0; margin-top:{text_margin_top};'>Yullase Pratiwi</h5>", unsafe_allow_html=True)
...
with col3:
    ...
    st.markdown(f"<h5 style='font-family:sans-serif; text-align:center; margin-bottom:0; margin-top:{text_margin_top};'>Fawwaz Rif’at Revista</h5>", unsafe_allow_html=True)
...
with col4:
    ...
    st.markdown(f"<h5 style='font-family:sans-serif; text-align:center; margin-bottom:0; margin-top:{text_margin_top};'>Galih Prabasidi</h5>", unsafe_allow_html=True)
