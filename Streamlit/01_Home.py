...
import requests
import json
from streamlit_lottie_player import st_lottie_player
import webbrowser
...
with container:
    ...
    with home2:
        ...
        st_lottie_player(lottie_json, height=400)
...
with container:
	...
	with col1:
		...
		st_lottie_player(chika_json, height=200, width=200, key="chika")
	...
	with col2:
		...
		st_lottie_player(kak_tiwi_json, height=200, width=200, key="tiwi")
	...
	with col3:
		...
		st_lottie_player(fawwaz_json, height=200, width=200, key="fawwaz")
	...
	with col4:
		...
		st_lottie_player(mas_galih_json, height=200, width=200, key="galih")
